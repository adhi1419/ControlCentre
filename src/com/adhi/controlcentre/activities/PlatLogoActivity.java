...
public class PlatLogoActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		prefs = getSharedPreferences("com.adhi.quantum", MODE_PRIVATE);
		...
		logo.setImageResource(R.drawable.kitkat_plat);
		...
		logo.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View v) {
				try {
					...
					intent.setComponent(new ComponentName("com.adhi.controlcentre",
							"com.adhi.controlcentre.activities.DessertCase"));
