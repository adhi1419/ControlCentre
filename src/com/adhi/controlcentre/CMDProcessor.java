package com.adhi.controlcentre;
...
import com.adhi.controlcentre.EasyPair;

//let it stay Public cos i"m using it everywhere.. Don't forget it
public class CMDProcessor {
    ...
    public class SH {
		...
		//Fix Warning is Eclipse so add Deprecation
